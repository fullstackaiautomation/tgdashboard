...
## Tasks / Subtasks
- [ ] Task 1: Add health time target configuration to life_areas table (AC: 1)
...
- [ ] Task 2: Build health time aggregation queries (AC: 2, 3, 8)
...
- [ ] Task 3: Create HealthTimeAllocationCard component (AC: 2, 3)
...
- [ ] Task 4: Implement visual warning indicators (AC: 4)
...
- [ ] Task 5: Build health time breakdown by activity type (AC: 5)
...
- [ ] Task 6: Implement streak tracking system (AC: 6)
...
- [ ] Task 7: Create health neglect risk detection system (AC: 7)
...
- [ ] Task 8: Build end-of-week health summary (AC: 8)
...
- [ ] Task 9: Implement quick health time scheduling from alerts (AC: 9)
...
- [ ] Task 10: Create health time monitoring dashboard section (AC: all)

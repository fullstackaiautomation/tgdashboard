...
- Run seed SQL to populate life_areas table with predefined categories (Health, Content, Personal, Shopping, Travel, Journal)
- Tasks can be created in Tasks Hub with life_area_id set, and they will sync properly with existing infrastructure

-- Debug and fix net worth calculation
-- This migration updates the function to ensure proper calculation of net worth
...
BEGIN
  ...
  SELECT
    -- Explicitly calculate: Total Assets - Total Debt
    -- This should return negative when debt > assets
    v_total_assets - v_total_debt as net_worth,
    mf.revenue,
    mf.expenses,
    bd.budget_amount,

...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-transparent group/calendar p-3 [--cell-size:3rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
